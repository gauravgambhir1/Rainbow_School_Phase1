...
namespace Rainbow_School
{
    ...
    public class School : Teacher
    {
        ...
        public string path = @"C:\Users\HP\Desktop\Phase1 Project\Phase1_Rainbow_School\FSDProject2_Teacher\TeacherRecord.txt";
                ...
                do
                {
                    ...
                    switch (option)
                    {
                        ...
                        case 4:
                            ...
                            Console.WriteLine("\nDo you want to Update for the record (Y/N) ?");
